...
def main(argv=None):
    ...
    print("Testing mIOU for class {}: {}".format(opt.class_choice, np.mean(shape_ious)))

    ## benchmark mIOU -  train
    shape_ious = []
    ...
    print("Training mIOU for class {}: {}".format(opt.class_choice, np.mean(shape_ious)))
    return
